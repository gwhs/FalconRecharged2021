...
/*
   ...
   Command autoCommand1 = new Autonomous(swerveDriveSubsystem, path1.getTrajectory(), path1.getAngle(), new Pose2d(0, 0, new Rotation2d(Math.PI / 2))); //new Pose2d(95, 30, new Rotation2d(Math.PI / 2))
