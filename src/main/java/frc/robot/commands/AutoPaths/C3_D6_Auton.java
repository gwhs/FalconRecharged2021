...
public class C3_D6_Auton extends SequentialCommandGroup {
  /**
   ...
   */
  public C3_D6_Auton(SwerveDriveSubsystem swerveDriveSubsystem) {  // test forward path
    ...
    super(
      ...
      new Autonomous(swerveDriveSubsystem, TrajectoryHelper.C3_to_D6().getTrajectory(), TrajectoryHelper.C3_to_D6().getAngle()).withTimeout(1)
    );
  }
