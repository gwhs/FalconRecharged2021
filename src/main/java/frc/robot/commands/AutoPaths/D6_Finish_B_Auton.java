...
public class D6_Finish_B_Auton extends SequentialCommandGroup {
  /**
   ...
   */
  public D6_Finish_B_Auton(SwerveDriveSubsystem swerveDriveSubsystem) {  // test forward path
    ...
    super(
      ...
      new Autonomous(swerveDriveSubsystem, TrajectoryHelper.D6_to_Finish_B().getTrajectory(), TrajectoryHelper.D6_to_Finish_B().getAngle()).withTimeout(1)
    );
  }
